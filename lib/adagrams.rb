...
# def draw_letters
#   letters = [
#     "A" * 9, ["B" * 2], ["C" * 2], ["D" * 4], ["E" * 12], ["F" * 2], ["G" * 3], ["H" * 2], ["I" * 9], ["J" * 1], ["K" * 1], ["L" * 4], ["M" * 2], ["N" * 6], ["O" * 8], ["P" * 2], ["Q" * 1], ["R" * 6], ["S" * 4], ["T" * 6], ["U" * 4], ["V" * 2], ["W": 2], ["Y": 2], ["Z" * 1]
#   ]
#   player_letters = [] #will hold return value
#     letters[0].map do |i|
#
#     end
#     return draw_letters.sample(10) #will not duplicate letters maybe .map somewhere?
#   end
...
if word.length == 10 && score == winner[:score]
  ...
  winner[:score] = score
    ...
    winner[:score] = score
      ...
      winner[:word] = word
      winner[:score] = score
# elsif word.length == winner[:word].length &&  winner[:score] == score
